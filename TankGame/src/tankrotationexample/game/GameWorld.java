...
// Variables for the game world
    ...
    private void displayHeath(Graphics2D onScreenPanel){
        onScreenPanel.drawImage(t1.getHealth(), (int)(GameConstants.GAME_SCREEN_WIDTH/2-(GameConstants.GAME_WORLD_WIDTH*.15)/2)+4,(int)(GameConstants.GAME_WORLD_HEIGHT*.15),null );
        onScreenPanel.drawImage(t2.getHealth(), (GameConstants.GAME_SCREEN_WIDTH/2 +10),(int)(GameConstants.GAME_WORLD_HEIGHT*.15),null );
        for(int n = 0; n < 3; n++){
            onScreenPanel.drawImage(t1.getHeart(n), (int)(GameConstants.GAME_SCREEN_WIDTH/2-(GameConstants.GAME_WORLD_WIDTH*.15)/2)+4 + (25*n),(int)(GameConstants.GAME_WORLD_HEIGHT*.15) + 25,null );
